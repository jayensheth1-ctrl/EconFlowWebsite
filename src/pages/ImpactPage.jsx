...
{ icon: Handshake, value: 11, suffix: '+', label: 'Global Partners', color: 'green' },
{ icon: Users, value: 600, suffix: '+', label: 'Students Impacted', color: 'purple' },
{ icon: BookOpen, value: 86, suffix: '+', label: 'Lessons across all sites', color: 'green' }];
